...
```text
节气令：出生时太阳所处的二十四节气段，描述长期认知行为偏好
日内段：出生时地方太阳时所处的光热时段，描述一日光热人格底色
类型名：节气令 · 日内光热段
```
...
- 日内端使用地方太阳时、日出、正午、午后高热、日落、夜初、深夜、黎明前等光热时段，描述人格底色中的昼夜体感层。
- 日内光热不是行动入口，而是出生时一日光暗、温度、社会活动节律对人格底色的刻印。
